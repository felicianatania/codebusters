...
<template>
    ...
    <div class="container flex space-x-44 w-50">
        <div class="w-50 mb-10">
            <div class="bg-darkyellow w-1/2 p-4">
            ...
            <div class="bg-darkyellow mt-7 w-1/2 p-4">
    ...
    <Link href="/beliRumah2" class="text-darkorange font-semibold"> Sebelumnya </Link>
